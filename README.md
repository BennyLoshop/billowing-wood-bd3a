...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/billowing-wood-bd3a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-wood-bd3a
```

A live public deployment of this template is available at [https://billowing-wood-bd3a.templates.workers.dev](https://billowing-wood-bd3a.templates.workers.dev)
